...
def h15 : List ℕ := [1, 6, 84]           -- conductors 3, 5, 15
def h30 : List ℕ := [1, 6, 9, 30, 84, 276]  -- conductors 3,5,6,10,15,30
...
def snf : List ℕ := [1, 1, 5, 5, 15, 15, 15, 15]
...
example : (6 : ℤ) - 30 = -24 := by native_decide
example : (5 : ℤ) - 9 = -4 := by native_decide
example : (8 : ℤ) * 8 * 4 = 256 := by native_decide
...
example : (48 : ℕ) + 212 + 432 + 114 = 806 ∧ 806 = 2 * 403 := by decide
...
example : (7 : ℤ) * (7 : ℤ) - 4 * 14 = -7 := by native_decide
...
example : 2^1 * (2^1 + 1) = 3 := by native_decide   -- g=1: three even
